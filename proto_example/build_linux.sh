...
../bin/linux/protoc --version
../bin/linux/protoc-gen-go --version
../bin/linux/protoc-gen-go-grpc --version
...
../bin/linux/protoc -I=./proto_src -I=./protoc-v3.5.1 --go-grpc_out=paths=source_relative:./proto_dst --go_out=paths=source_relative:./proto_dst $(find ./proto_src/ -name '*.proto')
