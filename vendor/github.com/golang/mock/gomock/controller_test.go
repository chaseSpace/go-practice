...
func createFixtures(t *testing.T) (reporter *ErrorReporter, ctrl *Controller) {
...
func TestUnexpectedArgValue_WantFormatter(t *testing.T) {
	...
	ctrl.RecordCall(
		...
		expectedArg0,
		WantFormatter(
			StringerFunc(func() string { return "is equal to fifteen" }),
			Eq(15),
		),
	)
...
func TestUnexpectedArgValue_GotFormatter(t *testing.T) {
	...
	ctrl.RecordCall(
		...
		expectedArg0,
		GotFormatterAdapter(
			GotFormatterFunc(func(i interface{}) string {
				// Leading 0s
...
func commonTestOrderedCalls(t *testing.T) (reporter *ErrorReporter, ctrl *Controller, subjectOne, subjectTwo *Subject) {
	reporter, ctrl = createFixtures(t)
...
func TestNoHelper(t *testing.T) {
	ctrlNoHelper := NewController(NewErrorReporter(t))
...
func TestWithHelper(t *testing.T) {
	...
	ctrlWithHelper := NewController(withHelper)
